...
let buttonElementBlue = document.getElementById("q1-btn-blue");  
buttonElementBlue.onclick = function(){

 setBackgroundColor("#073B4C");
}
let buttonElementRed = document.getElementById("q1-btn-red");  
buttonElementRed.onclick = function(){

 setBackgroundColor("#EF476F");
}
let buttonElementYellow = document.getElementById("q1-btn-yellow");  
buttonElementYellow.onclick = function(){

 setBackgroundColor("#FFD166");
}
let buttonElementLightBlue = document.getElementById("q1-btn-lightblue");  
buttonElementLightBlue.onclick = function(){

 setBackgroundColor("#118AB2");
}
let buttonElementGreen = document.getElementById("q1-btn-green");  
buttonElementGreen.onclick = function(){
